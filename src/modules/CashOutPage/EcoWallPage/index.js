      ...
      <div className="price-selection">
        <div className="top">
          <div className="top-left">
            <div>
              <Image
                src="/images/cashout/ecowall-small.png"
                width={215}
                height={65}
                alt=""
              />
            ...
            <div className="des">
              <Image
                ...
                alt=""
              />
              <div className="text">{t('desEcoWall')}</div>
            </div>
          </div>
        </div>
          ...
          <div className="address-wallet">
            <div className="input-address">
              ...
              <S.Text className="text">
                {coinbaseWallet ? t('theCoinbase') : t('theAddress')}
              </S.Text>
            </div>
